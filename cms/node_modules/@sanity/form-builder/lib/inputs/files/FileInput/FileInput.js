...
class FileInput extends _react.default.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_components.ImperativeToast, {
    ...
    }, !readOnly && /*#__PURE__*/_react.default.createElement(_FileInputButton.FileInputButton, {
      onSelect: this.handleSelectFiles,
      mode: "ghost",
      icon: _icons.UploadIcon,
      accept: accept,
      text: "Upload file"
    }), value && otherFields.length > 0 && /*#__PURE__*/_react.default.createElement(_ui.Button, {
      ...
      text: "Remove file",
      tone: "critical"
    }))), highlightedFields.length > 0 && this.renderFields(highlightedFields), isAdvancedEditOpen && this.renderAdvancedEdit(otherFields)));
  }
