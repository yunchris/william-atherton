...
var ReferenceInput = /*#__PURE__*/(0, _react.forwardRef)(function ReferenceInput(props, forwardedRef) {
  ...
  var renderValue = (0, _react.useCallback)(autocompleteValue => {
    ...
    return preview.isLoading ? 'Loading…' : ((_preview$snapshot2 = preview.snapshot) === null || _preview$snapshot2 === void 0 ? void 0 : _preview$snapshot2.title) || 'Untitled';
  ...
  return /*#__PURE__*/_react.default.createElement(_components.FormField, {
    ...
    prefix: /*#__PURE__*/_react.default.createElement(_ui.Box, {
      ...
      title: preview.snapshot ? "Open ".concat((_preview$snapshot5 = preview.snapshot) === null || _preview$snapshot5 === void 0 ? void 0 : _preview$snapshot5.title) : 'Loading…',
      intent: "edit",
      mode: "bleed",
      padding: 2,
