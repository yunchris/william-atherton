...
export declare const FormFieldSet: React.ForwardRefExoticComponent<FormFieldSetProps & Omit<React.HTMLProps<HTMLDivElement>, "as" | "height" | "ref"> & React.RefAttributes<unknown>>;
